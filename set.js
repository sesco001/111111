...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    NUMERO_OWNER : process.env.NUMERO_OWNER || "967730348571",  
    ...
    GURL: process.env.GURL  || "https://chat.whatsapp.com/BlUx7LC9KLD24RocTSb6cD",
    WEBSITE :process.env.GURL || "https://chat.whatsapp.com/BlUx7LC9KLD24RocTSb6cD",
    CAPTION : process.env.CAPTION || "✧ANOOS-BOT✧",
    BOT : process.env.BOT_NAME || '✧ANOOS_MD✧⁠',
